class StudiosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to studios_path, status: :see_other, notice: "Studio was successfully destroyed." }
  ...
  private
    ...
    def studio_params
      params.require(:studio).permit(:site_id, :width, :length, :height, :window, :sink)
    end
end
